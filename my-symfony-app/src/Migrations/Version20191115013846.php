 ...
 */
final class Version20191115013846 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, email, is_active FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, email, is_active) SELECT id, username, password, email, is_active FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__message');
        $this->addSql('CREATE INDEX IDX_B6BD307F217BBB47 ON message (person_id)');
        $this->addSql('ALTER TABLE user ADD COLUMN is_activated BOOLEAN NOT NULL');
    }
}
